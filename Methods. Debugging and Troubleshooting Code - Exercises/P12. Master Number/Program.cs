...
namespace P12.Master_Number
{
    class Program
    {
        ...
        public static bool IsPalindrome(int number) // метод за намиране на палиондром
        {
        ...
        public static bool SumOfDigits(int number) // намира числата които  се делят на 7
        {
            string str = number.ToString();
            int sumOfDigits = 0;
