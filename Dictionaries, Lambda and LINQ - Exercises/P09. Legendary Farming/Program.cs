...
namespace P09.Legendary_Farming
{
    class Program
    {
        ...
        private static void PrintAllItems(Dictionary<string, int> itemValues)
        {
        ...
        private static string CheckForLegendery(Dictionary<string, int> itemValues)
        {
            string itemForCraft = "";
...
//Shadowmourne – requires 250 Shards;   - key elements
