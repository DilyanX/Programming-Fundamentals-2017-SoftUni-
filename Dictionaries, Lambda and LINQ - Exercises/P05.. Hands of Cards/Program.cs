...
namespace P05._.Hands_of_Cards
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (input != "JOKER")
            {
                ...
                {
                    people.Add(name, new Dictionary<string, int>()); // добавя ми човека като KEY
            ...
            {
                Console.WriteLine($"{persone.Key}: {persone.Value.Values.Sum()}");
            }
        }
